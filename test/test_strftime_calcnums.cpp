...
namespace {
	...
	TEST_F(CalculatedNums, WeekMondayLastYear) {
		...
		curTm.tm_year = 2012 - 1900;
		c_strftime("%V");
		EXPECT_MEMGUARD_RESULT(2, "52"); // this is the previous year
	}
